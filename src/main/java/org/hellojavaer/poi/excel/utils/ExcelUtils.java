...
public class ExcelUtils {
    ...
    private static void convertFieldMapping(Sheet sheet, ExcelReadSheetProcessor<?> sheetProcessor,
        ...
        if (headRowIndex != null) {
            org.apache.poi.ss.usermodel.Row row = sheet.getRow(headRowIndex);
            if (row != null) {
        ...
        for (Map.Entry<String, Map<String, ExcelReadFieldMapping.ExcelReadFieldMappingAttribute>> entry : src.entrySet()) {
